Welcome! Perfect Produce Picker is a program that allows users to easily identify items from a database (that can be expanded)
using a combination of handwritten input (using the Leap Motion to write with index finger in the air and Tesseract OCR) and webcam RGB information using OpenCV.
